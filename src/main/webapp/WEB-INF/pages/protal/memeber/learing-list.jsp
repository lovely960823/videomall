                ...
                <div class="list-cont-left">
                    ...
                    <div class="tab-content">
                        <div class="content-list">
                            ...
                            <%-- <div class="recom-item">
                                <a href="#">
                                    <p><img src="${pageContext.request.contextPath }/static/img/widget-demo1.png" width="100%" alt=""><span class="lab">HOT</span></p>
                                    <ul>
                            ...
                            <div class="recom-item">
                                <a href="#">
                                    <p><img src="${pageContext.request.contextPath }/static/img/widget-demo2.png" width="100%" alt=""><span class="lab">HOT</span></p>
                                    <ul>
                                        <li>Think PHP 5.0 博客系统实战项目演练 </li>
                                        <li><span>高级</span> <em> · </em> 1125人在学习</li>
                                    </ul>
                            ...
                            <div class="recom-item">
                                <a href="#">
                                    <p><img src="${pageContext.request.contextPath }/static/img/widget-demo3.png" width="100%" alt=""><span class="lab">HOT</span></p>
                                    <ul>
                                        <li>Think PHP 5.0 博客系统实战项目演练 </li>
                                        <li><span>高级</span> <em> · </em> 1125人在学习</li>
                                    </ul>
                            ...
                            <div class="recom-item">
                                <a href="#">
                                    <p><img src="${pageContext.request.contextPath }/static/img/widget-demo4.png" width="100%" alt=""><span class="lab">HOT</span></p>
                                    <ul>
                                        <li>Think PHP 5.0 博客系统实战项目演练 </li>
                                        <li><span>高级</span> <em> · </em> 1125人在学习</li>
                                    </ul>
                            ...
                            <div class="recom-item">
                                <a href="#">
                                    <p><img src="${pageContext.request.contextPath }/static/img/widget-demo2.png" width="100%" alt=""></p>
                                    <ul>
                                        <li>Think PHP 5.0 博客系统实战项目演练 </li>
                                        <li><span>高级</span> <em> · </em> 1125人在学习</li>
                                    </ul>
                            ...
                            <div class="recom-item">
                                <a href="#">
                                    <p><img src="${pageContext.request.contextPath }/static/img/widget-demo3.png" width="100%" alt=""></p>
                                    <ul>
                                        <li>Think PHP 5.0 博客系统实战项目演练 </li>
                                        <li><span>高级</span> <em> · </em> 1125人在学习</li>
                                    </ul>
                            ...
                            <div class="recom-item">
                                <a href="#">
                                    <p><img src="${pageContext.request.contextPath }/static/img/widget-demo4.png" width="100%" alt=""></p>
                                    <ul>
                                        <li>Think PHP 5.0 博客系统实战项目演练 </li>
                                        <li><span>高级</span> <em> · </em> 1125人在学习</li>
                                    </ul>
                            ...
                            <div class="recom-item">
                                <a href="#">
                                    <p><img src="${pageContext.request.contextPath }/static/img/widget-demo1.png" width="100%" alt=""></p>
                                    <ul>
                                        <li>Think PHP 5.0 博客系统实战项目演练 </li>
                                        <li><span>高级</span> <em> · </em> 1125人在学习</li>
                                    </ul>
                        ...
                        <div class="contList">
                            <div class="contList-item">
                                <div class="box hov">
                                    ...
                                    <div class="infoImg">
                                        <div><img src="${pageContext.request.contextPath }/static/img/widget-btnbg.png" width="100%" height="110" alt=""></div>
                                        <div class="desc">通过对ThinkPHP框架基础，带领大家由浅入深轻松掌握ThinkPHP的理论基础，更加全面的掌握ThinkPHP框架运行机制……</div>
                                    </div>
                                </div>
                            </div>
