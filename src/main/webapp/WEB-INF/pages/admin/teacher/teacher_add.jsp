                 ...
                 <div class="layui-form-item">
                    <div class="layui-block">
                         <label for="researchDirection" class="layui-form-label">
                          ...
                          <div class="layui-input-block" style="width:40%;">
	                            <input type="text" id="tZc" name="tZc" required="" lay-verify="required" 
	                          autocomplete="off" class="layui-input">    
                          </div>
                     </div>
                      <div class="layui-form-mid layui-word-aux">
                  ...
                  <div class="layui-form-item">
                    <div class="layui-block">
                         <label for="researchDirection" class="layui-form-label">
                          ...
                          <div class="layui-input-block" style="width:40%;">
	                            <input type="text" id="tJy" name="tJy" required="" lay-verify="required" 
	                          autocomplete="off" class="layui-input">    
                          </div>
                     </div>
                      <div class="layui-form-mid layui-word-aux">
                    ...
                    <div class="layui-block">
                         <label for="researchDirection" class="layui-form-label">
                          ...
                          <div class="layui-input-block" style="width:60%;">
                              <textarea placeholder="" name="tContent" id="tContent"  class="layui-textarea" required="" lay-verify="required" ></textarea>
                          </div>
                     </div>
                      <div class="layui-form-mid layui-word-aux">
                      </div>
        ...
        layui.use(['form', 'layer', 'laydate'],
            function() {
                ...
                function(data) {
                    ...
                    console.log(form);
                    $.ajax({
	                    url:"${pageContext.request.contextPath }/manageros/teacher/add",
	                    data:form,
	                    type:"POST",
	                    async : false,
			            contentType: false,   
