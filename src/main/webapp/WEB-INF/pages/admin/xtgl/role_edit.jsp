			...
			<form class="layui-form">
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						...
						<input type="text" id="roleName" name="roleName" required="" value="${role.roleName }"
				...
				<div class="layui-form-item">
					...
					<button class="layui-btn btn-margR15" lay-filter="update" lay-submit="">
						修改</button>
					<button class="layui-btn layui-btn-danger" onclick="xadmin.close();" >
                                                                        返回</button>
				</div>
			</form>
		</div>
	...
	<script>
		layui.use([ 'form', 'layer' ], function() {
			...
			form.on('submit(update)', function(data) {
				...
				//发异步，把数据提交
				$.ajax({
                    url:"${pageContext.request.contextPath }/manageros/role/modifyRole",
                    data:data.field,
                    type:"POST",
