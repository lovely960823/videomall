...
<html class="x-admin-sm">
    ...
    <body>
                ...
                <form class="layui-form">
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="username" name="username" required="" lay-verify="required" onblur="selectName()"
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-block">
                        ...
                        <c:forEach items="${roles}" var="role">
                            <input type="checkbox" name="r_id" lay-skin="primary" title="${role.roleName}" value="${role.id }">
                        </c:forEach>
                      </div>
                  </div>
        ...
        function selectName(){
             ...
             $.get("${pageContext.request.contextPath}/manageros/user/selectUserByUname",
             {"username":username},
             function(data){
                 if(data>0){
                     //layer.alert("用户名已存在");
        ...
        layui.use(['form', 'layer'],
            function() {
                ...
                function(data) {
                    ...
                    $.ajax({
	                    url:"${pageContext.request.contextPath }/manageros/user/addUser",
	                    data:data.field,
	                    type:"POST",
