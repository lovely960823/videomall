     ...
     //根据条件查询表格数据重新加载
      ...
      $('#searchB').on('click',
        ...
        table.on('toolbar(test)', function(obj){
             if(obj.event === 'add'){
                 xadmin.open('添加轮播图','../../manageros/lunbo/toAdd','','',true); //${pageContext.request.contextPath }
                  setTimeout(function(){
      ...
      table.on('tool(test)', function(obj){
       ...
       if(obj.event === 'edit'){
          //打开编辑页面
          xadmin.open('编辑轮播图','../../manageros/lunbo/toUpdate?id='+data.id,'','',true); //${pageContext.request.contextPath }
          setTimeout(function(){
              layui.layer.tips('点击此处返回', '.layui-layer-setwin .layui-layer-close', {
              tips: 3
             });
