    ...
    <body>
        <div class="x-nav">
            <span class="layui-breadcrumb">
                ...
                <a href="javascript:void(0)">牛人推荐</a>
                        ...
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5">
                                ...
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" name="name" id="name" placeholder="请输入姓名"  autocomplete="off" class="layui-input"></div>
                                <div class="layui-inline layui-show-xs-block">
    ...
    layui.use('table', function(){
        ...
        table.render({
          ...
          ,cols: [[
            ...
            ,{field:'descr', title:'简介', width:'',align:'center'}
     ...
     //根据条件查询表格数据重新加载
      ...
      $('#searchB').on('click',
        ...
        table.on('toolbar(test)', function(obj){
             if(obj.event === 'add'){
                 xadmin.open('添加牛人','../../manageros/god/toAdd','','',true); //${pageContext.request.contextPath }
                  setTimeout(function(){
      ...
      table.on('tool(test)', function(obj){
       ...
       if(obj.event === 'edit'){
          //打开编辑页面
          xadmin.open('编辑牛人','../../manageros/god/toUpdate?id='+data.id,'','',true); //${pageContext.request.contextPath }
          setTimeout(function(){
              layui.layer.tips('点击此处返回', '.layui-layer-setwin .layui-layer-close', {
              tips: 3
             });
