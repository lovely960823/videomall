                    ...
                    <div class="layui-block">
                         <label for="researchDirection" class="layui-form-label">
                          ...
                          <div class="layui-input-block" style="width:60%;">
                              <textarea placeholder="" name="descr" id="descr"  class="layui-textarea" required="" lay-verify="required" ></textarea>
                          </div>
                     </div>
                      <div class="layui-form-mid layui-word-aux">
                      </div>
        ...
        layui.use(['form', 'layer', 'laydate'],
            function() {
                ...
                function(data) {
                    ...
                    console.log(form);
                    $.ajax({
	                    url:"${pageContext.request.contextPath }/manageros/god/add",
	                    data:form,
	                    type:"POST",
	                    async : false,
			            contentType: false,   
