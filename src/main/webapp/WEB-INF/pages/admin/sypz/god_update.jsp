    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                ...
                <input name="id" value="${god.id}" type="hidden">
                    ...
                    <div class="layui-block">
                         <label for="researchDirection" class="layui-form-label">
                          ...
                          <div class="layui-input-block" style="width:40%;">
	                          ...
	                          autocomplete="off" class="layui-input" value="${god.name }" >    
                          </div>
                     </div>
                    ...
                    <div class="layui-block">
                         <label for="researchDirection" class="layui-form-label">
                          ...
                          <div class="layui-input-block" style="width:60%;">
                              <textarea placeholder="" name="descr" id="descr"  class="layui-textarea" required="" lay-verify="required" >${god.descr }</textarea>
                          </div>
                     </div>
                      <div class="layui-form-mid layui-word-aux">
                      </div>
        ...
        layui.use(['form', 'layer', 'laydate'],
            function() {
                ...
                function(data) {
                    ...
                    $.ajax({
	                    url:"${pageContext.request.contextPath }/manageros/god/update",
	                    data:form,
	                    type:"POST",
	                    async : false,
			            contentType: false,   
