        ...
        <script type="text/javascript">
            ...
            KindEditor.ready(function(K) {
                editor = K.create('textarea[name="cptd"]', {
                    ...
                    uploadJson: '${pageContext.request.contextPath }/static/js/editor/jsp/upload_json.jsp',
                    fileManagerJson: '${pageContext.request.contextPath }/static/js/editor/jsp/file_manager_json.jsp', //可以不写
                    ...
                    <div class="layui-tab-item layui-show">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block" style="width: 40%;">
                               <input type="text" id="" name="name"  autocomplete="off" class="layui-input">
                            </div>
                        </div>
          ...
          ,uploadListIns = upload.render({
           ...
           //监听提交
            ...
            function(data) {
                ...
                $.ajax({
                    url:"${pageContext.request.contextPath }/manageros/cpzx/add",
                    data:formData,
                    type:"POST",
